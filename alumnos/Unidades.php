               ...
               <thead>
                ...
                <td style="width: 24%; height: 83%;">&nbsp;
                    ...
                    <div class="card text-white bg-primary  o-hidden h-100">
                     ...
                     <div class="text-white bg-primary o-hidden h-100">    
                        <button type="button" class="btn btn-primary dropdown-toggle" href="#" role="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item" href="unidades/Unidad2/unidad2-1.php" aling="center">CONTENIDOS:</a>
                              <a class="dropdown-item" href="unidades/Unidad2/unidad2-1.php">2.1 Modelo Conceptual.</a>
                ...
                <td style="width: 398.152%; height: 83%;"> &nbsp;<p aling="Justify" aling-text="center" >Definir el concepto y el objetivo principal del modelo de entidad relación mediante la solución de un problema de estudio   </p> </td>
                </tr>
                ...
                <td style="width: 24%; height: 80%;">&nbsp;<p aling="Justify" aling-text="center" >Definir el concepto y el objetivo principal del modelo relacional en el trabajo de fin de curso </p> </td>
                <td style="width: 24%; height: 80%;">&nbsp;
                     <div class="dropdown show" >
                    <!--div class="col-xl-3 col-sm-6 mb-3"-->
                    <div class="card text-white bg-primary  o-hidden h-100">
                ...
                <td style="width: 398.152%; height: 80%;">&nbsp; <p aling="Justify" aling-text="center" ><b>Definir las operaciones del algebra relacional y los tres lenguajes que son parte de Transact SQL a través del gestor de bases de datos SQL Server </b></p></td>
                </tr>
                <tr style="height: 72px;">
                <td style="width: 24%; height: 72%;">&nbsp;
                    <div class="dropdown show" >
                    <!--div class="col-xl-3 col-sm-6 mb-3"-->
                    <div class="card text-white bg-primary  o-hidden h-100">
                        <div class="card-body">    
                ...
                <td style="width: 24%; height: 72%;">&nbsp;<p aling="Justify" aling-text="center" >Definir que son las bases de datos cliente servidor y las bases de datos distribuida a través de un caso de estudio real </p></td>
                <td style="width: 24%; height: 72%;">&nbsp;
                 <div class="dropdown show" >
                    <!--div class="col-xl-3 col-sm-6 mb-3"-->
                   <div class="card text-white bg-primary  o-hidden h-100">
                ...
                <td style="width: 398.152%; height: 72%;">&nbsp;<p aling="Justify" aling-text="center" >Definir el proceso de análisis y recolección de los requerimientos para el diseño de una base de datos a través de un caso de estudio </p></td>
                </tr>
        </tbody>
</table>
  </div>
