...
if(isset($_SESSION['NombreUsuario'])) {
 ...
 <?php 
          ...
          $profesor2=mysqli_query($conex,"select idProfesor, concat(NombresProfesor, ' ' ,ApellidosProfesor) as Profesor FROM profesor");
...
<div class="card border-primary">
        ...
        <div class="card body">
            ...
            <div class="modal-body">
                      ...
                      <form class="form-group" method="post" action="reportes/Reporte_Asignaciones_Por_profesor.php">
                     <div class="form-group row"> <label for="carrera" class="col-md-3 control-label">Busqueda por profesor:</label>
                         <div class="col-md-4">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                        <form class="form" method="post" action="reportes/Reporte_Asignaciones_Filtradas.php">
                         <div class="form-group row"> <label for="carrera" class="col-md-2 control-label">Seleccione profesor:</label>
                         <div class="col-md-4">
                       <select class="form-control" id="profesor" name="profesor">
                     <?php 
                          while($fila=mysqli_fetch_row($profesor2)){
                          echo "<option value='".$fila['0']."'>".$fila['1']."</option>";
                          }
                          ?>
                      </select>
